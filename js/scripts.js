...
function rsvp_markup(groupNames, afterParty) {
    ...
    return '<div class="row"> <div class="col-md-12"> <h3>What are you waiting for? </h3> <form class="gform" id="rsvp-form" class="rsvp-form" action="" method="POST"> <table class="responsive-table">' + tableHeaders  + groupNameMarkUp + '</table> <div class="row"> <div class="col-md-12" id="alert-wrapper2"> </div> </div> <em><p><a href="https://forms.gle/hKt8W2w1aDpaBY7fA"><b>REQUIRED: Click here to upload your vaccines!</b></a></p></em> <button class="btn-fill rsvp-btn">Submit!</button> </form> </div> </div> <div id="playlist" class="row"> </div> ';
}
